...
abstract class RepositoryModule {
    ...
    @Binds @Singleton
    abstract fun bindFixedIncomeInvestmentRepository(impl: FixedIncomeInvestmentRepositoryImpl): FixedIncomeInvestmentRepository

    @Binds @Singleton
    abstract fun bindMonthlySnapshotRepository(impl: MonthlySnapshotRepositoryImpl): MonthlySnapshotRepository

    @Binds @Singleton
    abstract fun bindUserMissionRepository(impl: UserMissionRepositoryImpl): UserMissionRepository

    @Binds @Singleton
    abstract fun bindUserAchievementRepository(impl: UserAchievementRepositoryImpl): UserAchievementRepository

    @Binds @Singleton
    abstract fun bindStockPriceRepository(impl: StockPriceRepositoryImpl): StockPriceRepository
